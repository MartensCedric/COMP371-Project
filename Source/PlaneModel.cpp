...
PlaneModel::PlaneModel() {
	setShader(Shader::textureLightShader);
	...
	std::vector<Vertex> vertices = {
		Vertex(glm::vec3(-25.5, 0, 25.5), color, normal, glm::vec2(0, 2)),
		Vertex(glm::vec3(25.5, 0, 25.5), color, normal, glm::vec2(2, 2)),
		Vertex(glm::vec3(25.5, 0, -25.5), color, normal, glm::vec2(2, 0)),

		Vertex(glm::vec3(25.5, 0, -25.5), color, normal, glm::vec2(2, 0)),
		Vertex(glm::vec3(-25.5, 0, -25.5), color, normal, glm::vec2(0, 0)),
		Vertex(glm::vec3(-25.5, 0, 25.5), color, normal, glm::vec2(0, 2))
	};
