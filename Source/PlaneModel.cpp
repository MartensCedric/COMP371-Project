...
PlaneModel::PlaneModel() {
	...
	Vertex planeGrid[] = {
		Vertex(glm::vec3(-25.f, 0.01, 25.0), color,glm::vec2(0.0f, 8.0f)),
		Vertex(glm::vec3(25.f, 0.01, 25.0), color,glm::vec2(8.0f, 8.0f)),
		Vertex(glm::vec3(25.f, 0.01, -25.0), color,glm::vec2(8.0f, 0.0f)),
